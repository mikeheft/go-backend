...
// Source: github.com/mikeheft/go-backend/db/sqlc (interfaces: Store)
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 db.ListEntriesParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
