...
var file_login_user_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x66, 0x2f, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72,
	...
	0x41, 0x74, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x6d, 0x69, 0x6b, 0x65, 0x68, 0x65, 0x66, 0x74, 0x2f, 0x67, 0x6f, 0x2d, 0x62, 0x61, 0x63,
...
func file_login_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_login_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_login_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
